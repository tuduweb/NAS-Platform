...
from compute.gpu import gpus_all_task_free
...
class FitnessEvaluate(object):
    ...
    def evaluate(self):
        ...
        while all_have_been_evaluated is not True:
            ...
            time.sleep(60)
            all_have_been_evaluated = gpus_all_task_free()
