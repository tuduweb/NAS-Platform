...
def dispatch_to_do(_id, _uuid):
    ...
    if gpu_info is not None:
        worker_ip, gpu_id, ssh_name, ssh_password, ssh_port =   gpu_info['worker_ip'], \
                                                                gpu_info['gpu_id'], \
                                                                gpu_info['ssh_name'], \
        ...
        for src, dst in sync_file_list:
            transfer_file_relative(ssh_name, ssh_password, worker_ip, worker_name, src, dst, port = ssh_port)
