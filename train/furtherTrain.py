...
class TrainModel(object):
    ...
    def main_val(self, epoch):
        ...
        if 1 - correct / total < self.best_error:
            ...
            torch.save({'model': self.net.state_dict(), 'acc': 1 - self.best_error}, os.path.join(self.ptSavedPath, self.file_id + ".fullepoch.pt"))
...
class RunModel(object):
    ...
    def do_work(self, gpu_id, file_id, uuid = ""):
        ...
        logger = RedisLog("full-" + os.path.basename(file_id) + '.txt')
        best_error = 100.0
